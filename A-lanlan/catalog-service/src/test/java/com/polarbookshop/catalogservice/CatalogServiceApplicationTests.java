...
//        ResultBox<Book> box = ResultBox.success(expectedBook);
//
//        webTestClient
//                .post()
//                .uri("/books")
...
//                .exchange()
//                .expectStatus().isCreated()
//                .expectBody(ResponseEntity.class).value(entity -> {
//                    ResultBox<Book> res = (ResultBox<Book>) entity.getBody();
//
//                    assertThat(res).isNotNull();
//                    assertThat(res.getData().isbn()).isEqualTo(expectedBook.isbn());
//                });
//    }
//
//    @Test
